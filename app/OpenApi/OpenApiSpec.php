...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'payment_status', type: 'string', enum: ['paid', 'partial', 'credit', 'unpaid']),
        new OA\Property(property: 'total_amount', type: 'number', format: 'float'),
        new OA\Property(property: 'paid_amount', type: 'number', format: 'float'),
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'status', type: 'string', enum: ['open', 'partial', 'paid', 'closed']),
